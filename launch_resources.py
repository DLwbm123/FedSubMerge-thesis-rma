...
def main():
    ...
    pending = [(d, m) for d in ('pathmnist', 'hyperkvasir') for m in methods]
    active, finished = [], []
    while pending or active:
        ...
        for gpu in (2, 3):
            ...
            for dataset, method in list(pending):
                required = 18000 if dataset == 'pathmnist' else 37000
                ...
                cmd = [sys.executable, '-u', str(root / 'code/run_resources.py'), '--dataset', dataset,
